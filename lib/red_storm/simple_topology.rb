  ...
  class SimpleTopology
    ...
    def start(base_class_path, env)
      ...
      self.class.spouts.each do |spout|
        declarer = builder.setSpout(spout.id, spout.new_instance(base_class_path), Java::JavaLang::Integer.new(spout.parallelism))
        declarer.addConfigurations(spout.config)
      end
      self.class.bolts.each do |bolt|
        declarer = builder.setBolt(bolt.id, bolt.new_instance(base_class_path), Java::JavaLang::Integer.new(bolt.parallelism))
